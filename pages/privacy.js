            ...
            <div className={privacyStyles.privacy_container}>
                <div className={privacyStyles.terms_block}>
                    <p className={styles1.info_text}>
                        By reading this document you submit an agreement between https://tagiamtop.com/ further
                        called tagiamtop or We and you (further called Customer) on the rules and conditions
                        listed in this Privacy Policy. If you have some doubts whether to agree with any statement
                ...
                <TextComponent
                    ...
                    text={
                        <p className={styles1.info_text} style={{ lineHeight: 3 }}>
                            ...
                            on the website https://tagiamtop.com/  by the Customer including email and contact
