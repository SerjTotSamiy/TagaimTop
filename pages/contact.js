        ...
        <Layer firstPage={false}>
            <Head>
                ...
                <meta
                    name="title"
                    property="og:title"
                    content="Contact Us - Tag I am Top"
                />
                <meta name="twitter:title" content="Contact Us - Tag I am Top"/>
                <meta
                    name="description"
                    property="og:description"
                    content="Got any questions or feedback? Contact Us - Tag I am Top."
                />
                <meta
            ...
            <Modal open={open} onClose={() => setOpen(false)}>
                <Box sx={style} className={privacyStyles.contactModal}>
                    <h1>Thank you!</h1>
                    <p>Within 12 hours you will receive a response. Thank you!</p>
                    <ButtonComponent
                        text="Home page"
                        type="fill"
                        onClick={() => router.push("/")}
