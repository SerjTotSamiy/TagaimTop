  ...
  return (
    ...
    >
      <div className={styles.menu}>
        ...
        <Link href={"/"}>
          {firstPage ? (
            <img src="/logo_white_top.svg" alt="" />
          ) : (
      ...
      <div className={`${styles.menu_open} ${openMenu && styles.active}`}>
        <Link href={"/buy-instagram-likes"}>
          <span className={styles.mobile_span}>Buy Instagram Likes</span>
        </Link>
        <Link href={"/buy-instagram-followers"}>
          <span className={styles.mobile_span}>Buy Instagram Followers</span>
        </Link>
        <Link href={"/buy-instagram-views"}>
