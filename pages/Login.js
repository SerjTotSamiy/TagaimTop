    ...
    <Layer firstPage={false}>
      <div className={loginStyles.loginBg}>
        <div className={loginStyles.login_container}>
          ...
          >
            <p
              className={homeStyles.info_title}
              style={{ textAlign: "center" }}
            >
              My account
            </p>
            <p className={homeStyles.info_text} style={{ textAlign: "center" }}>
              Log in to manage your account. Use the creadentials that you
              entered suring checkout.
            </p>
            ...
            <a
              ...
              onClick={() => router.push(`${router.pathname}/ForgotPassword`)}
            >
              Forgot Password?
            </a>
          </div>
