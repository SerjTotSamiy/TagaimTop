...
const Questions = ({questions,title,bg}) => {
            ...
            <div className={styles.question_container}>
                ...
                <div className={styles.question_div_data}>
                    {questions.map((item, index) => {
                        return (
                            <Accordion key={index} expanded={activePost.includes(item.index)} style={{borderRadius:10,marginBottom:10,maxWidth:"990px",width:"100%"}}  >
                                <AccordionSummary
